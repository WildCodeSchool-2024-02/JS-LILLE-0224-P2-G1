      ...
      <section className="tasting_container">
        ...
        <div className="card_tasting">
          <img
            ...
            alt="a beer below the eiffel tower"
          />
          <div className="card-content">
            <h1>15/06/2024</h1>
            <h2>PARIS</h2>
      ...
      <section className="tasting_container">
        ...
        <div className="card_tasting">
          <img
            ...
            alt="three beer glasses on the beach lit by the sun"
          />
          <div className="card-content">
            <h1>12/10/2024</h1>
            <h2>BREST</h2>
